...
class RelationControl extends _react.default.Component {
  ...
  async componentDidMount() {
    ...
    if (initialSearchValues && initialSearchValues.length > 0) {
      ...
      const initialOptions = [].concat(...(0, _sortBy2.default)(allOptions, ({
        index
      }) => index).map(({
        options
      }) => options));
